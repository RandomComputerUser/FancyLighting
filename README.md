...
#### `"AddCustomTileLighting", int tileType, Func<Tile, int, int, Vector3, Vector3> tileLightModifier`
Add custom lighting for a particular tile type when using Smooth Lighting.

- **Call Parameters:**
  - `int tileType`: The affected tile type.
  - `Func<Tile, int, int, Vector3, Vector3> tileLightModifier`: The function that modifies the tile's light color.
    - **Parameters:**
      - `Tile tile`: The affected tile.
      - `int x`: The x-coordinate of the tile.
      - `int y`: The y-coordinate of the tile.
      - `Vector3 lightColor`: The light color at the location of the tile, after global brightness is applied.
    - **Returns:** `Vector3`
      - The modified light color to apply to the tile.
...
#### `"AddCustomTileLighting", ushort tileType, Func<Tile, int, int, Vector3, Vector3> tileLightModifier`
Same as above, except `tileType` is passed as a ushort.

### AddHook

#### `"AddHook", "PostUpdateLightMap", Action<Texture2D, Matrix, Rectangle, bool> hook`
Add a hook that runs after Smooth Lighting updates its light map texture. This exposes the light map texture.

- **Call Parameters:**
  - `Action<Texture2D, Matrix, Rectangle, bool> hook`: The hook.
    - **Parameters:**
...
#### `"AddHook", "PreDrawSky", Func<Vector3, Vector3, Vector3, (Vector3, Vector3, Vector3)> hook`
Add a hook that runs before Fancy Atmosphere draws the sky. This allows the color of the sky to be modified.

- **Call Parameters:**
  - `Func<Vector3, Vector3, Vector3, (Vector3, Vector3, Vector3)> hook`: The hook.
    - **Parameters:**
